...
<details>
    <summary>Season 2 목적</summary>

- 명확한설계
  - 개념간구분을 명확히 할줄안다
  - 최초설계ㆍ모델링자체를 같은것은같게 다른것은다르게 구별설계할줄안다.
- 컨벤션특정
  - 관례특정
    - 개발에서 Convetention들이 제각각임에도
    - 나름의규율 나름의관례있기에 그것을 더특정하는것으로 목표한다.
  - 인간설계
    - AI설계아닌 인간설계로서 할줄안다.
    - 작업환경상 인간설계로서 협업도모할줄안다.
    - 인간코드로서 사람이사람에게 전할수있는 그런코드중심으로 지향할줄안다.
    - AI통한 복잡성 수려한코드아닌, 인간중심 명확성ㆍ단순성 통한 효율성ㆍ최소성을 구비한코드를 짤줄안다.
- 기계적구현
  - 컨벤션확신을 세울줄안다.
  - 기계적설계를 구현한다.
</details>
<details>
    <summary>Season 2 장소</summary>

- 건대입구
- [Season 1 장소](https://github.com/BitcoPark/season1_bitcopark?tab=readme-ov-file#%EA%B9%8A%EC%9D%B4%EC%9E%88%EB%8A%94-%EA%B0%9C%EB%B0%9C%EC%9E%90%EA%B0%80-%EB%90%98%EA%B8%B0-%EC%9C%84%ED%95%9C-%EC%8A%A4%ED%84%B0%EB%94%94)
</details>
<details open>
    <summary>Season 2 멤버</summary>


- `Season 1 멤버` + `Seasson 2 멤버`
<table>
  <tr>
    <td align="center">
